...
socket.onmessage = (event) => {
  ...
  if (
    ...
    mapIndex.innerHTML = `CS: <span style="font-weight: 700">${tempCS}</span> / AR: <span style="font-weight: 700">${tempAR}</span> / OD: <span style="font-weight: 700">${tempOD}</span></br>Star Rating: <span style="font-weight: 700">${tempSR}*</span>`;
